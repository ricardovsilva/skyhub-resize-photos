...
class FileDownloaderTests < Test::Unit::TestCase
  ...
  def test__save_foo__should_save_foo_at_output_dir
    @file_downloader.save("foo_1.jpg")
  ...
  def test__save_foo_with_image_resize_filters__should_return_four_images_paths
    ...
    actual = @file_downloader.save("foo_1.jpg").map { |file| File.basename file }
